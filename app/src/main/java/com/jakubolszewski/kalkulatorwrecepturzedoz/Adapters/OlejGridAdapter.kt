...
class OlejGridAdapter(
    private val resultsList: List<OlejGridModel>,
...
//BaseAdapter is a class that is used to create a custom adapter for a listview
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            convertView = layoutInflater!!.inflate(R.layout.oleje_gridview_item, null)
        }
        ...
        main_vit_TV.text = resultsList[position].main_olej
        main_vit2_TV.text =
            if (density != -1.0) resultsList[position].main_olej2 else density.toString()
