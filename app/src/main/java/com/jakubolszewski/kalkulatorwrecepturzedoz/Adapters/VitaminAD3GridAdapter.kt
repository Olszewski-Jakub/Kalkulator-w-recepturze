...
internal class VitaminAD3GridAdapter(
    private val resultsList: ArrayList<VitaminAD3GridModel>,
...
//BaseAdapter is a class that is used to create a custom adapter for a listview
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            convertView = layoutInflater!!.inflate(R.layout.vitamin_a_d3_gridview_item, null)
        }
