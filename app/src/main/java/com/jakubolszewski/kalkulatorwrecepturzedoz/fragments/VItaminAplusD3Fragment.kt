...
class VItaminAplusD3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_v_itamin_aplus_d3, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment VItaminAplusD3Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VItaminAplusD3Fragment().apply {
